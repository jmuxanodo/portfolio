const imgChanger = document.querySelector(".crest");

function iChange() {
    if (imgChanger.classList.querySelector('crest')) {
        document.querySelector("crest").classList.remove("deactive")
    }
}
...
(() => {
    ...
    const colorClick = document.querySelector(".style-switcher-toggler");
    ...
    console.log(opeMenuBtn);

    function showNavMenu() {
        navMenu.classList.add("open");
        navMenu.classList.remove("close");
        opeMenuBtn.classList.add("hide");
        closeNavBtn.classList.remove("hide");
        if (document.querySelector(".switcher-popup").classList.contains("open")) {
    ...
    function hideNavMenu() {
        ...
        opeMenuBtn.classList.remove("hide");
    ...
    window.addEventListener("scroll", () => {
        if (document.querySelector(".open-menu").classList.contains("hide")) {
...
(() => {
    ...
    function popupDetails() {
        // if project doesnt have details
        if (!portfolioItems[itemIndex].querySelector(".portfolio-item-details")) {
            projectDetailsBtn.style.display = "none";
            return; /* end fuction exection */
        }
